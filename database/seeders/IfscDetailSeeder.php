    ...
    public function run(): void
    {
        ...
        $ifscDetails = [
            [
                ...
                'branch_address' => 'Ring Road, Surat, Gujarat',
                'city' => 'Surat',
                'state' => 'Gujarat',
            ],
            [
                ...
                'branch_address' => 'Ashram Road, Ahmedabad, Gujarat',
                'city' => 'Ahmedabad',
                'state' => 'Gujarat',
            ],
            [
                ...
                'branch_name' => 'Surat Main Branch',
                'branch_address' => 'Ghod Dod Road, Surat, Gujarat',
                'city' => 'Surat',
                'state' => 'Gujarat',
            ],
            [
                ...
                'branch_address' => 'Fort Area, Mumbai, Maharashtra',
                'city' => 'Mumbai',
                'state' => 'Maharashtra',
            ],
            [
            ...
            [
                ...
                'branch_address' => 'Adajan Main Road, Surat, Gujarat',
                'city' => 'Surat',
                'state' => 'Gujarat',
            ],
            [
